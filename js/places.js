...
const PLACES = {
  ...
  badeseen: [
    ...
    { name:'Happurger Stausee', addr:'Seepromenade 1, 91230 Happurg', city:'Hersbruck', lat:49.4994, lng:11.4533, tags:['Stausee','Segeln','Angeln','Café'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Happurger+Stausee+Seepromenade', highlight:'Segeln, Angeln, Restaurant „Seeterrassen" – Fränkische Schweiz' },
    ...
    { name:'Igelsbachsee', addr:'Zum Igelsbachsee, 91174 Spalt', city:'Roth', lat:49.1736, lng:10.9028, tags:['Badesee','Kletterpark','Tretboote','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Igelsbachsee+Spalt', highlight:'Sandstrand, Erlebnis-Kletterpark, Tretboote, 550 Parkplätze – ruhige Alternative zum Brombachsee' },
    { name:'Dennenloher See', addr:'Dennenloher Stausee 1, 91743 Unterschwaningen', city:'Ansbach', lat:49.0758, lng:10.6519, tags:['Badesee','Bootsverleih','Campingplatz','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Dennenloher+See+Unterschwaningen', highlight:'Kleinster See im Fränkischen Seenland – Bootsverleih, Campingplatz, Seehausgaststätte' },
    // ── Fränkische Schweiz / Oberpfalz ──
    { name:'Felsenbad Pottenstein', addr:'Pegnitzer Str. 35, 91278 Pottenstein', city:'Pottenstein', lat:49.7763, lng:11.4097, tags:['Naturbad','Felskulisse','Biergarten','Fränkische Schweiz'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Felsenbad+Pottenstein', highlight:'Naturbad in imposanter Felskulisse – Quellfreibad bis 24°C, Sprungfelsen, Biergarten' },
    { name:'Naturbad Königstein', addr:'Badstraße 3, 92281 Königstein', city:'Königstein', lat:49.5893, lng:11.7753, tags:['Naturbad','Quellwasser','Familie','Oberpfalz'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Naturbad+Königstein', highlight:'Natürliches Quellwasser, Sprungfelsen, Naturbach im Kinderbereich – Oberpfalz' },
    { name:'Murner See Wackersdorf', addr:'Sonnenrieder Str. 1, 92442 Wackersdorf', city:'Wackersdorf', lat:49.3622, lng:12.1672, tags:['Badesee','Oberpfälzer Seenland','Tretboote','Strandbar'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Murner+See+Wackersdorf', highlight:'Ex-Kohlegrube, renaturiert – wärmt schnell auf, Strandbar, Tretboote, Geheimtipp' },
    { name:'Eixendorfer Stausee', addr:'Eixendorf, 92447 Schwarzach b. Nabburg', city:'Regensburg', lat:49.4278, lng:12.3556, tags:['Stausee','Oberpfalz','Camping','Wassersport'], preis:'Parkplatz', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Eixendorfer+Stausee', highlight:'Großer Stausee im Schwarzachtal – Surfen, Angeln, Camping, Naherholung Oberpfalz' },
    // ── Ansbach / Dinkelsbühl ──
    { name:'Erlensee Schnelldorf', addr:'Birkenbergstr., 91625 Schnelldorf', city:'Ansbach', lat:49.1844, lng:10.2189, tags:['Badesee','Camping','Grillen'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Erlensee+Schnelldorf', highlight:'Baden, Grillen, Campingplatz am Ufer – südlich von Ansbach' },
    { name:'Wörnitzstrandbad Dinkelsbühl', addr:'Bleichweg 2, 91550 Dinkelsbühl', city:'Dinkelsbühl', lat:49.0683, lng:10.3189, tags:['Flussbad','Altstadt','Tretboote','Historisch'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Wörnitzstrandbad+Dinkelsbühl', highlight:'Eines der letzten Flussbäder Bayerns – vor der Kulisse der mittelalterlichen Altstadt' },
    // ── Augsburg / Schwaben ──
    { name:'Mandichosee', addr:'Merching, 86504 Merching', city:'Augsburg', lat:48.2340, lng:10.9878, tags:['Badesee','SUP','Windsurfen','Biergarten'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Mandichosee+Merching', highlight:'Lechstaustufe mit Windsurfen, SUP, Biergarten – zwischen Augsburg und Fürstenfeldbruck' },
    // ── Oberbayern (Tagesausflug ~2h) ──
    { name:'Starnberger See', addr:'Starnberg, 82319 Starnberg', city:'Starnberg', lat:47.9333, lng:11.3167, tags:['Bergsee','Oberbayern','Segeln','Dampfer'], preis:'Kostenlos (Eintritt Strandbäder)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Starnberger+See', highlight:'„Badewanne Münchens" – 56 km², Dampferfahrten, Strandbäder, Bergblick' },
    { name:'Ammersee', addr:'Herrsching, 82211 Herrsching', city:'Augsburg', lat:48.0000, lng:11.1333, tags:['Bergsee','Oberbayern','Segeln','Familie'], preis:'Kostenlos (Eintritt Strandbäder)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Ammersee+Herrsching', highlight:'Drittgrößter See Bayerns – flache Strände, ideal für Familien, Segelrevier' },
    { name:'Tegernsee', addr:'Tegernsee, 83684 Tegernsee', city:'München', lat:47.7000, lng:11.7667, tags:['Bergsee','Oberbayern','Bergpanorama','Klar'], preis:'Kostenlos (öffentl. Badestellen)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Tegernsee', highlight:'50 km von München – kristallklares Wasser, Bergpanorama, mondäne Uferorte' },
    { name:'Chiemsee', addr:'Prien am Chiemsee, 83209 Prien', city:'München', lat:47.8778, lng:12.4633, tags:['Bergsee','Oberbayern','Inseln','Schloss'], preis:'Kostenlos (öffentl. Badestellen)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Chiemsee+Prien', highlight:'„Bayerisches Meer" – 80 km², Herreninsel mit Schloss, Fähren, breite Badeplätze' },
  ],
