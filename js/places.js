...
const PLACE_CATS = [
  ...
  { id:'badeseen',     icon:'🏖️',  name:'Badeseen',               color:'#34d399', desc:'Naturbäder, Baggerseen, Seen zum Schwimmen',             count:56 },
...
const PLACES = {
  ...
  badeseen: [
    ...
    { name:'Rothsee', addr:'Erholungszentrum Birkach, 91161 Hilpoltstein', city:'Roth', lat:49.1958, lng:10.9711, tags:['Badesee','Segeln','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Rothsee+Hilpoltstein', highlight:'2,1 km² Stausee, 12 km Rundweg, EU-Wasserqualität „ausgezeichnet" – Landkreis Roth', size:'3,1 km²' },
    ...
    { name:'Dennenloher See', addr:'Dennenloher Stausee 1, 91743 Unterschwaningen', city:'Ansbach', lat:49.0758, lng:10.6519, tags:['Badesee','Bootsverleih','Campingplatz','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Dennenloher+See+Unterschwaningen', highlight:'Kleinster See im Fränkischen Seenland – Bootsverleih, Campingplatz, Seehausgaststätte', size:'0,25 km²' },
    // ── Fränkische Schweiz / Oberpfalz ──
    { name:'Felsenbad Pottenstein', addr:'Pegnitzer Str. 35, 91278 Pottenstein', city:'Pottenstein', lat:49.7763, lng:11.4097, tags:['Naturbad','Felskulisse','Biergarten','Fränkische Schweiz'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Felsenbad+Pottenstein', highlight:'Naturbad in imposanter Felskulisse – Quellfreibad bis 24°C, Sprungfelsen, Biergarten', size:'1 ha' },
    ...
    { name:'Chiemsee', addr:'Prien am Chiemsee, 83209 Prien', city:'München', lat:47.8778, lng:12.4633, tags:['Bergsee','Oberbayern','Inseln','Schloss'], preis:'Kostenlos (öffentl. Badestellen)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Chiemsee+Prien', highlight:'„Bayerisches Meer" – 80 km², Herreninsel mit Schloss, Fähren, breite Badeplätze', size:'79,9 km²' },
