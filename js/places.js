...
const PLACE_CATS = [
  ...
  { id:'badeseen',     icon:'🏖️',  name:'Badeseen',               color:'#34d399', desc:'Naturbäder, Baggerseen, Seen zum Schwimmen',             count:57 },
...
const PLACES = {
  ...
  baeder: [
    ...
    { name:'Volksbad Nürnberg', addr:'Badstr. 2, 90429 Nürnberg', city:'Nürnberg', lat:49.4604, lng:11.0575, tags:['Hallenbad','Historisch'], preis:'4–7€', oeffnung:'Mo-Sa 6:30-22, So 8-20 Uhr', web:'baeder.nuernberg.de', maps:'https://maps.google.com/?q=Volksbad+Nürnberg', rating:4.3, reviews:2100},
    ...
    // Fürth
    { name:'Fürthermare Erlebnisbad', addr:'Rosenstr. 89, 90762 Fürth', city:'Fürth', lat:49.4739, lng:10.9731, tags:['Erlebnisbad','Sauna','Rutsche'], preis:'Erw. 14€, Kind 9€', oeffnung:'Mo-Do 10-22, Fr-So 9-22 Uhr', web:'fuerthermare.de', maps:'https://maps.google.com/?q=Fürthermare+Fürth', highlight:'Größtes Erlebnisbad Franken', rating:4.3, reviews:3100},
    ...
    // Spaßbäder Region
    { name:'Schlossbad Neumarkt', addr:'Seelstraße 20, 92318 Neumarkt i.d.OPf.', city:'Neumarkt', lat:49.281, lng:11.462, tags:['Erlebnisbad','Freibad','Sauna','Ganzjahresbad'], preis:'Erw. ab 9€', oeffnung:'Tägl. 10-21 Uhr, So ab 9 Uhr', web:'schlossbad-neumarkt.de', maps:'https://maps.google.com/?q=Schlossbad+Neumarkt+Oberpfalz', highlight:'Modernes Ganzjahresbad mit Solebecken, Erlebnisbecken, 5 Saunen und Freibad', rating:4.3, reviews:1200},
    { name:'Wonnemar Ingolstadt', addr:'Am Sportpark 1, 85053 Ingolstadt', city:'Ingolstadt', lat:48.7577, lng:11.4337, tags:['Erlebnisbad','Sauna','Wellness'], preis:'Erw. 16€', oeffnung:'Mo-So 10-22 Uhr', web:'wonnemar.de/ingolstadt', maps:'https://maps.google.com/?q=Wonnemar+Ingolstadt', highlight:'Riesenrutsche & Wellenbad', rating:4.2, reviews:1900},
    { name:'H2O Roth', addr:'Nördliche Ringstr. 120, 91154 Roth', city:'Roth', lat:49.2481, lng:11.0922, tags:['Hallenbad','Sauna'], preis:'5–9€', oeffnung:'Mo-So', web:'h2o-roth.de', maps:'https://maps.google.com/?q=H2O+Roth', rating:4.2, reviews:980},
  { name:'Freizeitbad Atlantis Herzogenaurach', addr:'Würzburger Str. 35, 91074 Herzogenaurach', city:'Herzogenaurach', lat:49.567,lng:10.882, tags:['Erlebnisbad','Wellenbad','Sauna'], preis:'Erw. ab 8€', oeffnung:'Tägl. 10-22 Uhr, Sauna bis 23 Uhr', web:'atlantis-bad.de', maps:'https://maps.google.com/?q=Freizeitbad+Atlantis+Herzogenaurach', highlight:'1.200qm Wasserfläche mit Wellenbad, Rutschen + 1.700qm Saunaparadies mit Außensaunen' },
    ...
    { name:'Bambados Bamberg', addr:'Pödeldorfer Str. 234, 96050 Bamberg', city:'Bamberg', lat:49.9084, lng:10.9236, tags:['Erlebnisbad','Sauna','Wellness'], preis:'Erw. 13€', oeffnung:'Mo-So 10-22 Uhr', web:'bambados.de', maps:'https://maps.google.com/?q=Bambados+Bamberg', highlight:'Top Saunalandschaft Franken', rating:4.4, reviews:2800},
    ...
    { name:'Franken-Therme Bad Windsheim', addr:'Ernst-Ludwig-Weg 20, 91438 Bad Windsheim', city:'Ansbach', lat:49.5002, lng:10.4153, tags:['Therme','Heilwasser','Sauna'], preis:'Erw. 18€', oeffnung:'Mo-So 9-22 Uhr', web:'frankentherme.de', maps:'https://maps.google.com/?q=Franken-Therme+Bad+Windsheim', highlight:'Heilwasser-Therme mit Solebecken', rating:4.2, reviews:2100},
    ...
    { name:'Therme Erding', addr:'Thermenallee 1, 85435 Erding', city:'München', lat:48.2878, lng:11.9097, tags:['Therme','Wellness','Rutsche'], preis:'Erw. ab 25€', oeffnung:'tägl. 9-23 Uhr', web:'therme-erding.de', maps:'https://maps.google.com/?q=Therme+Erding', highlight:'Größte Therme der Welt', rating:4.5, reviews:18200},
  ...
  kultur: [
    ...
    { name:'Kaiserburg Nürnberg', addr:'Auf der Burg 13, 90403 Nürnberg', city:'Nürnberg', lat:49.4591, lng:11.0736, tags:['Burg','Geschichte','Aussicht'], preis:'Erw 7€', oeffnung:'tägl. 9-18 Uhr', web:'kaiserburg-nuernberg.de', maps:'https://maps.google.com/?q=Kaiserburg+Nürnberg', highlight:'Kaiserpfalz mit Panorama über Nürnberg', rating:4.5, reviews:38000},
    ...
    { name:'Cadolzburg (Burg)', addr:'Burg 19, 90556 Cadolzburg', city:'Zirndorf', lat:49.4996, lng:10.8611, tags:['Burg','Geschichte','Ausflug'], preis:'Erw 5€', oeffnung:'Di-So', web:'cadolzburg.de', maps:'https://maps.google.com/?q=Burg+Cadolzburg', rating:4.4, reviews:2200},
  ...
  badeseen: [
    ...
    { name:'Naturfreibad Großhabersdorf', addr:'Nürnberger Str. 12, 90613 Großhabersdorf', city:'Großhabersdorf', lat:49.4422, lng:10.8667, tags:['Naturbad','Familie','Mittelfranken'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Naturfreibad+Großhabersdorf', highlight:'Eines der größten Naturfreibäder Mittelfrankens – Sprungfelsen, Rutsche, ohne Chemie', size:'2 ha' },
    { name:'Rothsee', addr:'Erholungszentrum Birkach, 91161 Hilpoltstein', city:'Roth', lat:49.1958, lng:10.9711, tags:['Badesee','Segeln','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Rothsee+Hilpoltstein', highlight:'2,1 km² Stausee, 12 km Rundweg, EU-Wasserqualität „ausgezeichnet" – Landkreis Roth', size:'3,1 km²', rating:4.3, reviews:2900},
    ...
    { name:'Kesselfleischweiher Georgensgmünd', addr:'Georgensgmünd, 91166 Georgensgmünd', city:'Roth', lat:49.1942, lng:11.0086, tags:['Badesee','Landkreis Roth','Kostenlos','Naherholung'], preis:'Kostenlos', oeffnung:'Sommer (unbewacht)', web:'', maps:'https://maps.google.com/?q=Kesselfleischweiher+Georgensgmünd', highlight:'Idyllischer Badesee bei Georgensgmünd – Landkreis Roth, ruhige Liegewiesen', size:'3 ha' },
    // ── Erlangen & Umgebung ──
    { name:'Dechsendorfer Weiher', addr:'Erlangen-Dechsendorf', city:'Erlangen', lat:49.6017, lng:10.9594, tags:['Badesee','Erlangen','Familie'], preis:'Kostenlos', oeffnung:'Sommer (unbewacht)', web:'visit-erlangen.de', maps:'https://maps.google.com/?q=Dechsendorfer+Weiher+Erlangen', highlight:'Bekanntester See in Erlangen – Grillen, Kiosk, Liegewiesen (auf eigene Gefahr)', size:'15 ha' },
    { name:'Angersee / Baiersdorfer Weiher', addr:'Baiersdorf, 91083 Baiersdorf', city:'Erlangen', lat:49.6572, lng:11.0350, tags:['Badesee','Sandstrand','Erlangen Nähe'], preis:'Kostenlos', oeffnung:'Sommer (unbewacht)', web:'', maps:'https://maps.google.com/?q=Angersee+Baiersdorf', highlight:'Kleiner Sandstrand, grüne Liegewiesen – nordöstlich von Erlangen (auf eigene Gefahr)', size:'4 ha' },
    // ── Fränkisches Seenland (50–80 km) ──
    { name:'Großer Brombachsee', addr:'Leitenbuckstraße, 91785 Pleinfeld', city:'Gunzenhausen', lat:49.1122, lng:10.9033, tags:['Badesee','Wassersport','Kite-Surfen','Segeln'], preis:'Parkplatz ca. 3€', oeffnung:'Sommer', web:'brombachsee.de', maps:'https://maps.google.com/?q=Großer+Brombachsee+Pleinfeld', highlight:'ADAC-Top-Ranking 2024 – Sandstrand, Kite-Surfen, Schiffsrundfahrten, EU „ausgezeichnet"', size:'9,1 km²', rating:4.5, reviews:6400},
    { name:'Kleiner Brombachsee', addr:'Badehalbinsel 1, 91720 Absberg', city:'Gunzenhausen', lat:49.1083, lng:10.8467, tags:['Badesee','Wakeboard','Windsurfen','Tretboote'], preis:'Parkplatz ca. 3€', oeffnung:'Sommer', web:'brombachsee.de', maps:'https://maps.google.com/?q=Kleiner+Brombachsee+Absberg', highlight:'3. schönster See Bayerns – Wakeboard-Anlage, Windsurfschule, Strandhotel Seehof', size:'0,6 km²', rating:4.4, reviews:3200},
    { name:'Altmühlsee', addr:'Seezentrum Muhr am See, 91735 Muhr am See', city:'Gunzenhausen', lat:49.1133, lng:10.7028, tags:['Badesee','Vogelinsel','Ausflugschiff','Franken'], preis:'Parkplatz ca. 3€', oeffnung:'Sommer', web:'altmuehlsee.de', maps:'https://maps.google.com/?q=Altmühlsee+Gunzenhausen', highlight:'Vogelinsel, 4 Seezentren, Ausflugschiff MS Altmühlsee – Fränkisches Seenland', size:'5,5 km²', rating:4.5, reviews:4100},
    { name:'Hahnenkammsee', addr:'Ortsteil Hechlingen, 91719 Heidenheim', city:'Gunzenhausen', lat:49.0617, lng:10.7333, tags:['Badesee','Sandstrand','Fränkisches Seenland'], preis:'Parkplatz', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Hahnenkammsee+Hechlingen', highlight:'Ältester Stausee im Fränkischen Seenland – neuer Sandstrand, Schwimmer- und Nichtschwimmerbereich', size:'0,6 km²', rating:4.4, reviews:1800},
    { name:'Naturfreibad Weißbachmühle', addr:'Weißbachmühle, 91732 Merkendorf', city:'Merkendorf', lat:49.2040, lng:10.7000, tags:['Naturfreibad','Sandstrand','Sprungturm','Wasserrutsche','Familie','Camping','Fränkisches Seenland'], preis:'Kostenlos (Parken ab 1€, Tagesticket 5€)', oeffnung:'Apr-Sep tägl. 10-20 Uhr', web:'', maps:'https://maps.google.com/?q=Naturfreibad+Weißbachmühle+Merkendorf', highlight:'Eintritt kostenlos – Sandstrand, Wasserrutsche & Sprungturm, Spielplatz, warme Duschen, Stellplätze für Wohnmobile & Zelte. Ca. 50 Min. von Nürnberg.', size:'ca. 1 ha' },
    { name:'Igelsbachsee', addr:'Zum Igelsbachsee, 91174 Spalt', city:'Roth', lat:49.1736, lng:10.9028, tags:['Badesee','Kletterpark','Tretboote','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Igelsbachsee+Spalt', highlight:'Sandstrand, Erlebnis-Kletterpark, Tretboote, 550 Parkplätze – ruhige Alternative zum Brombachsee', size:'0,7 km²', rating:4.4, reviews:2100},
    { name:'Dennenloher See', addr:'Dennenloher Stausee 1, 91743 Unterschwaningen', city:'Ansbach', lat:49.0758, lng:10.6519, tags:['Badesee','Bootsverleih','Campingplatz','Familie'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Dennenloher+See+Unterschwaningen', highlight:'Kleinster See im Fränkischen Seenland – Bootsverleih, Campingplatz, Seehausgaststätte', size:'0,25 km²', rating:4.4, reviews:1100},
    // ── Fränkische Schweiz / Oberpfalz ──
    { name:'Felsenbad Pottenstein', addr:'Pegnitzer Str. 35, 91278 Pottenstein', city:'Pottenstein', lat:49.7763, lng:11.4097, tags:['Naturbad','Felskulisse','Biergarten','Fränkische Schweiz'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Felsenbad+Pottenstein', highlight:'Naturbad in imposanter Felskulisse – Quellfreibad bis 24°C, Sprungfelsen, Biergarten', size:'1 ha', rating:4.6, reviews:1700},
    { name:'Naturbad Königstein', addr:'Badstraße 3, 92281 Königstein', city:'Königstein', lat:49.5893, lng:11.7753, tags:['Naturbad','Quellwasser','Familie','Oberpfalz'], preis:'Eintritt', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Naturbad+Königstein', highlight:'Natürliches Quellwasser, Sprungfelsen, Naturbach im Kinderbereich – Oberpfalz', size:'1 ha' },
    { name:'Murner See Wackersdorf', addr:'Sonnenrieder Str. 1, 92442 Wackersdorf', city:'Wackersdorf', lat:49.3622, lng:12.1672, tags:['Badesee','Oberpfälzer Seenland','Tretboote','Strandbar'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Murner+See+Wackersdorf', highlight:'Ex-Kohlegrube, renaturiert – wärmt schnell auf, Strandbar, Tretboote, Geheimtipp', size:'0,5 km²', rating:4.4, reviews:2300},
    { name:'Eixendorfer Stausee', addr:'Eixendorf, 92447 Schwarzach b. Nabburg', city:'Regensburg', lat:49.4278, lng:12.3556, tags:['Stausee','Oberpfalz','Camping','Wassersport'], preis:'Parkplatz', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Eixendorfer+Stausee', highlight:'Großer Stausee im Schwarzachtal – Surfen, Angeln, Camping, Naherholung Oberpfalz', size:'1,9 km²', rating:4.3, reviews:1200},
    // ── Ansbach / Dinkelsbühl ──
    { name:'Erlensee Schnelldorf', addr:'Birkenbergstr., 91625 Schnelldorf', city:'Ansbach', lat:49.1844, lng:10.2189, tags:['Badesee','Camping','Grillen'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Erlensee+Schnelldorf', highlight:'Baden, Grillen, Campingplatz am Ufer – südlich von Ansbach', size:'8 ha' },
    { name:'Wörnitzstrandbad Dinkelsbühl', addr:'Bleichweg 2, 91550 Dinkelsbühl', city:'Dinkelsbühl', lat:49.0683, lng:10.3189, tags:['Flussbad','Altstadt','Tretboote','Historisch'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Wörnitzstrandbad+Dinkelsbühl', highlight:'Eines der letzten Flussbäder Bayerns – vor der Kulisse der mittelalterlichen Altstadt', size:'— (Fluss)' },
    // ── Augsburg / Schwaben ──
    { name:'Mandichosee', addr:'Merching, 86504 Merching', city:'Augsburg', lat:48.2340, lng:10.9878, tags:['Badesee','SUP','Windsurfen','Biergarten'], preis:'Kostenlos', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Mandichosee+Merching', highlight:'Lechstaustufe mit Windsurfen, SUP, Biergarten – zwischen Augsburg und Fürstenfeldbruck', size:'30 ha', rating:4.3, reviews:1600},
    // ── Oberbayern (Tagesausflug ~2h) ──
    { name:'Starnberger See', addr:'Starnberg, 82319 Starnberg', city:'Starnberg', lat:47.9333, lng:11.3167, tags:['Bergsee','Oberbayern','Segeln','Dampfer'], preis:'Kostenlos (Eintritt Strandbäder)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Starnberger+See', highlight:'„Badewanne Münchens" – 56 km², Dampferfahrten, Strandbäder, Bergblick', size:'56,4 km²', rating:4.7, reviews:21000},
    { name:'Ammersee', addr:'Herrsching, 82211 Herrsching', city:'Augsburg', lat:48.0000, lng:11.1333, tags:['Bergsee','Oberbayern','Segeln','Familie'], preis:'Kostenlos (Eintritt Strandbäder)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Ammersee+Herrsching', highlight:'Drittgrößter See Bayerns – flache Strände, ideal für Familien, Segelrevier', size:'46,6 km²', rating:4.7, reviews:15000},
    { name:'Tegernsee', addr:'Tegernsee, 83684 Tegernsee', city:'München', lat:47.7000, lng:11.7667, tags:['Bergsee','Oberbayern','Bergpanorama','Klar'], preis:'Kostenlos (öffentl. Badestellen)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Tegernsee', highlight:'50 km von München – kristallklares Wasser, Bergpanorama, mondäne Uferorte', size:'8,8 km²', rating:4.8, reviews:19000},
    { name:'Chiemsee', addr:'Prien am Chiemsee, 83209 Prien', city:'München', lat:47.8778, lng:12.4633, tags:['Bergsee','Oberbayern','Inseln','Schloss'], preis:'Kostenlos (öffentl. Badestellen)', oeffnung:'Sommer', web:'', maps:'https://maps.google.com/?q=Chiemsee+Prien', highlight:'„Bayerisches Meer" – 80 km², Herreninsel mit Schloss, Fähren, breite Badeplätze', size:'79,9 km²', rating:4.7, reviews:24000},

    // ── Oberbayern – weitere Seen ──
    { name:'Walchensee', addr:'Walchensee-Dorf, 82432 Walchensee', city:'München', lat:47.6000, lng:11.3833, tags:['Bergsee','Oberbayern','Klar','Wassersport'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Walchensee', size:'16,4 km²', highlight:'Tiefster und klarster Bergsee Deutschlands (75 m) – Smaragdgrün, Windsurfen, Alpenkulisse' },
    { name:'Kochelsee', addr:'Kochel am See, 82431 Kochel am See', city:'München', lat:47.6500, lng:11.3667, tags:['Voralpensee','Oberbayern','Familie','Freibad'], preis:'Freibad ca. 4 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Kochelsee', size:'5,6 km²', highlight:'Naturbelassener Voralpensee – Freibad mit Rutsche, Alpenpanorama, Ausflug zum Walchensee' },
    { name:'Waginger See', addr:'Waging am See, 83329 Waging', city:'Waging', lat:47.9333, lng:12.7333, tags:['Badesee','Oberbayern','Warm','Familie'], preis:'Kostenlos (Strandbäder ab 3 €)', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Waginger+See', size:'5,7 km²', highlight:'Wärmster Badesee Oberbayerns – bis 27 °C, Sandstrände, SUP-Verleih, ausgezeichnete Wasserqualität' },
    { name:'Tachinger See', addr:'Taching am See, 83329 Taching', city:'Waging', lat:47.9333, lng:12.7667, tags:['Badesee','Oberbayern','Ruhig','Familie'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Tachinger+See', size:'0,6 km²', highlight:'Kleiner Schwester-See des Waginger Sees – ruhiger, flache Ufer, Campingplatz direkt am Ufer' },
    { name:'Königssee', addr:'Schönau am Königssee, 83471 Schönau', city:'Berchtesgaden', lat:47.5833, lng:12.9833, tags:['Bergsee','Nationalpark','Berchtesgaden','Schiff'], preis:'Kostenlos (Bootsfahrt ab 12 €)', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Königssee+Schönau', size:'5,2 km²', highlight:'Eindrucksvollster Bergsee Deutschlands – senkrechte Felswände, Elektroboote, St.-Bartholomä-Kirche' },
    { name:'Wörthsee', addr:'Wörthsee, 82237 Wörthsee', city:'Wörthsee', lat:48.0667, lng:11.1667, tags:['Badesee','Fünfseenland','Natur','Ruhig'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Wörthsee', size:'1,9 km²', highlight:'Idyllischer Natursee im Fünfseenland – öffentl. Badestellen am Nordwestufer, ruhige Atmosphäre' },
    { name:'Pilsensee', addr:'Seefeld-Hechendorf, 82229 Seefeld', city:'Seefeld', lat:48.0333, lng:11.1333, tags:['Badesee','Fünfseenland','Natur','Geheimtipp'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Pilsensee+Seefeld', size:'2,3 km²', highlight:'Ruhigerer Begleitsee des Ammersees im Fünfseenland – wenig Trubel, Alpenpanorama' },
    { name:'Simssee', addr:'Bad Endorf, 83093 Bad Endorf', city:'Bad Endorf', lat:47.9000, lng:12.2000, tags:['Badesee','Chiemgau','Geheimtipp','Natur'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Simssee+Bad+Endorf', size:'5,0 km²', highlight:'Geheimtipp im Chiemgau – ruhige Alternative zum Chiemsee, naturbelassene Ufer, Bergblick' },
    { name:'Riegsee', addr:'Riegsee, 82418 Murnau', city:'Murnau', lat:47.6667, lng:11.1500, tags:['Bergsee','Blaues Land','Murnau','Geheimtipp'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Riegsee+Murnau', size:'1,0 km²', highlight:'Malerischer See im Blauen Land – glasklares Wasser, kein Massentourismus, Zelten am Ufer möglich' },
    { name:'Staffelsee', addr:'Uffing am Staffelsee, 82449 Uffing', city:'Murnau', lat:47.7000, lng:11.1667, tags:['Bergsee','Blaues Land','7 Inseln','Kitesurf'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Staffelsee+Uffing', size:'7,8 km²', highlight:'7 Inseln, warmes klares Wasser – Blaues Land bei Murnau, Kitesurf-Revier, Bergpanorama' },
    { name:'Feringasee', addr:'Unterföhring, 85774 Unterföhring', city:'München', lat:48.2100, lng:11.6600, tags:['Badesee','München Nähe','FKK','Kiesgrube'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Feringasee+Unterföhring', size:'14 ha', highlight:'Beliebter Naherholungssee nördl. München – sonnige Liegewiesen, FKK-Bereich, sehr gute Wasserqualität' },
    { name:'Unterschleißheimer See', addr:'Unterschleißheim, 85716 Unterschleißheim', city:'München', lat:48.2800, lng:11.5800, tags:['Badesee','München Nähe','Freibad','Familie'], preis:'Freibad ca. 4 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Unterschleißheimer+See', size:'22 ha', highlight:'Beliebter Naherholungssee im Münchner Norden – Freibad, Liegewiesen, Spiel- und Sportanlagen' },
    // ── Allgäu / Schwaben ──
    { name:'Forggensee', addr:'Füssen, 87629 Füssen', city:'Füssen', lat:47.6500, lng:10.6833, tags:['Stausee','Allgäu','Neuschwanstein','Wassersport'], preis:'Kostenlos', oeffnung:'Jun–Sep', web:'', maps:'https://maps.google.com/?q=Forggensee+Füssen', size:'15,7 km²', highlight:'Größter Stausee Bayerns – ab Juni voll aufgestaut, Sandstrände, Blick auf Schloss Neuschwanstein' },
    { name:'Großer Alpsee', addr:'Immenstadt im Allgäu, 87509 Immenstadt', city:'Immenstadt', lat:47.5833, lng:10.2500, tags:['Bergsee','Allgäu','Wassersport','Freibad'], preis:'Freibad ca. 3 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Großer+Alpsee+Immenstadt', size:'1,8 km²', highlight:'Größter natürlicher See im Allgäu – Bergpanorama, Surfen, Segeln, oft starker Wind' },
    { name:'Kleiner Alpsee', addr:'Bühl am Alpsee, 87509 Immenstadt', city:'Immenstadt', lat:47.5833, lng:10.2667, tags:['Bergsee','Allgäu','Geheimtipp','Natur'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Kleiner+Alpsee+Bühl', size:'0,17 km²', highlight:'Idyllisches Schwesterchen des Großen Alpsees – ruhig, naturbelassen, Geheimtipp ohne Trubel' },
    { name:'Hopfensee', addr:'Hopfen am See, 87629 Füssen', city:'Füssen', lat:47.6000, lng:10.6667, tags:['Badesee','Allgäu','Heilklimatisch','Alpenpanorama'], preis:'Kostenlos (Strandbad ca. 4 €)', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Hopfensee+Füssen', size:'1,7 km²', highlight:'Heilklimatisches Kurgebiet – warmes klares Wasser, Blick auf Zugspitze, moorhaltige Sedimente' },
    { name:'Weißensee', addr:'Weißensee, 87629 Füssen', city:'Füssen', lat:47.6167, lng:10.6833, tags:['Bergsee','Allgäu','Geheimtipp','Natur'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Weißensee+Füssen', size:'0,7 km²', highlight:'Kleiner Geheimtipp nahe Füssen – kristallklares Wasser, Wald, Alpenpanorama, wenig Betrieb' },
    { name:'Rottachsee', addr:'Rettenberg, 87549 Rettenberg', city:'Rettenberg', lat:47.5500, lng:10.3333, tags:['Badesee','Oberallgäu','Größter See','Natur'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Rottachsee+Rettenberg', size:'2,5 km²', highlight:'Größter See im Oberallgäu – naturbelassen, Bergpanorama, Naturstrand, ideal zum Wandern' },
    { name:'Autobahnsee Augsburg', addr:'Leitershofen, 86156 Augsburg', city:'Augsburg', lat:48.3600, lng:10.7900, tags:['Badesee','Augsburg','Freibad','FKK'], preis:'Eintritt ca. 5 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Autobahnsee+Augsburg', size:'38 ha', highlight:'Bekannter Naherholungssee an der A8 – Freibad mit Rutsche, Beachvolleyball, FKK-Bereich' },
    { name:'Kuhsee Augsburg', addr:'Augsburg-Haunstetten, 86179 Augsburg', city:'Augsburg', lat:48.3300, lng:10.9000, tags:['Badesee','Augsburg','Naturufer','FKK'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Kuhsee+Augsburg', size:'11 ha', highlight:'Ruhigerer Natursee im Augsburger Süden – FKK-Bereich, Liegewiesen, beliebtes Radlerziel' },
    // ── Oberpfalz / Bayerischer Wald ──
    { name:'Steinberger See', addr:'Steinberg am See, 92449 Steinberg', city:'Schwandorf', lat:49.3500, lng:12.1000, tags:['Badesee','Oberpfalz','Erlebniskugel','Wassersport'], preis:'Strandbad ca. 5 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Steinberger+See', size:'2,8 km²', highlight:'Größter See der Oberpfalz – weltberühmte Holzkugel auf dem Wasser, Sandstrand, Wasserski, Blaue Flagge EU' },
    { name:'Guggenberger See', addr:'Neutraubling, 93073 Neutraubling', city:'Regensburg', lat:48.9800, lng:12.1300, tags:['Badesee','Regensburg','Freibad','Kiesgrube'], preis:'Freibad ca. 4 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Guggenberger+See+Neutraubling', size:'0,35 km²', highlight:'„Der Guggi" – Hauptbadesee der Region Regensburg, Freibad mit Rutsche, FKK-Bereich, familienfreundlich' },
    { name:'Sperlsee', addr:'Viechtach, 94234 Viechtach', city:'Viechtach', lat:49.0700, lng:12.8800, tags:['Badesee','Bayerischer Wald','Naturidylle','Familie'], preis:'Freibad ca. 3 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Sperlsee+Viechtach', size:'0,4 km²', highlight:'Idyllischer Natursee im Bayerischen Wald – ruhiges Freibad, Liegewiesen, Camping direkt am See' },
    { name:'Satzdorfer See', addr:'Regen, 94209 Regen', city:'Regen', lat:48.9700, lng:13.1300, tags:['Badesee','Bayerischer Wald','Geheimtipp','Natur'], preis:'Kostenlos', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Satzdorfer+See+Regen', size:'0,3 km²', highlight:'Kleiner Geheimtipp im Bayerischen Wald bei Regen – naturbelassener Badestrand, Waldwanderung' },
    // ── Oberfranken / Unterfranken ──
    { name:'Untreusee', addr:'Hof, 95028 Hof', city:'Hof', lat:50.3500, lng:11.9000, tags:['Badesee','Oberfranken','Freibad','Familie'], preis:'Freibad ca. 4 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Untreusee+Hof', size:'1,1 km²', highlight:'Beliebtester Badesee Oberfrankens – Sandstrand, Freibad, FKK-Bereich, Minigolf, zu Fuß vom Hbf' },
    { name:'Trebgaster Badesee', addr:'Trebgast, 95367 Trebgast', city:'Kulmbach', lat:50.1200, lng:11.5800, tags:['Badesee','Oberfranken','Kulmbach','Familie'], preis:'Freibad ca. 3 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Trebgaster+Badesee', size:'5 ha', highlight:'Gepflegter Naherholungssee im Landkreis Kulmbach – Freibad, Liegewiesen, ruhige Lage' },
    { name:'Baggersee Schweinfurt', addr:'Schweinfurt, 97421 Schweinfurt', city:'Schweinfurt', lat:50.0600, lng:10.2200, tags:['Badesee','Unterfranken','Freibad','Beachvolleyball'], preis:'Freibad ca. 4 €', oeffnung:'Mai–Sep', web:'', maps:'https://maps.google.com/?q=Baggersee+Schweinfurt', size:'0,6 km²', highlight:'Großes Freizeitzentrum Schweinfurt – Badesee, Beachvolleyball, Discgolf, FKK-Bereich, Grillplätze' },
  ],
  ...
  ausflugsziele: [
    ...
    { name:'Fränkische Schweiz (Wiesenttal)', addr:'Pottenstein – Tüchersfeld', city:'Hersbruck', lat:49.7744, lng:11.4156, tags:['Natur','Wandern','Felsen'], preis:'Kostenlos', oeffnung:'ganzjährig', web:'fraenkische-schweiz.com', maps:'https://maps.google.com/?q=Fränkische+Schweiz', rating:4.8, reviews:8900},
    { name:'Teufelshöhle Pottenstein', addr:'91278 Pottenstein', city:'Hersbruck', lat:49.7696, lng:11.4165, tags:['Höhle','Natur','Führung'], preis:'Erw 9€', oeffnung:'Apr-Nov', web:'teufelshöhle-pottenstein.de', maps:'https://maps.google.com/?q=Teufelshöhle+Pottenstein', highlight:'Größte Schauhöhle Frankens', rating:4.5, reviews:2600},
    ...
    { name:'Burg Abenberg (Spitzenmuseum)', addr:'Burgstr. 16, 91183 Abenberg', city:'Roth', lat:49.2365, lng:10.9542, tags:['Burg','Spitzenklöppeln','Geschichte'], preis:'4€', oeffnung:'Di-So', web:'burg-abenberg.de', maps:'https://maps.google.com/?q=Burg+Abenberg', rating:4.4, reviews:890},
    { name:'Walberla (Ehrenbürg)', addr:'Kirchehrenbach', city:'Forchheim', lat:49.7679, lng:11.1044, tags:['Aussichtsberg','Wandern','Franken'], preis:'Kostenlos', oeffnung:'ganzjährig', web:'', maps:'https://maps.google.com/?q=Walberla+Ehrenbürg', highlight:'Heiliger Berg Frankens, Panorama', rating:4.7, reviews:4200},
...
function placeRatingHtml(p) {
  if (!p.rating) return '';
  const r = p.rating;
  const full = Math.floor(r);
  const half = (r % 1) >= 0.25 && (r % 1) < 0.75;
  const empty = 5 - full - (half ? 1 : 0);
  const stars = '★'.repeat(full) + (half ? '½' : '') + '☆'.repeat(empty);
  const count = p.reviews ? `<span class="place-rating-count">(${p.reviews.toLocaleString('de-DE')})</span>` : '';
  return `<div class="place-rating"><span class="place-rating-stars">${stars}</span><span class="place-rating-score">${r.toFixed(1)}</span>${count}</div>`;
}
