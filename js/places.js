...
const PLACES = {
  ...
  baeder: [
    ...
    { name:'Freibad Seepark Fürth', addr:'Seeanlage 1, 90763 Fürth', city:'Fürth', lat:49.4834, lng:10.9788, tags:['Freibad','See'], preis:'3.50€', oeffnung:'Mai-Sep', web:'', maps:'https://maps.google.com/?q=Seepark+Fürth' },
    // Erlangen
    { name:'Erlangen Bürgermeistersteg-Freibad', addr:'Bürgermeistersteg 2, 91054 Erlangen', city:'Erlangen', lat:49.5910, lng:11.0078, tags:['Freibad','Pegnitz'], preis:'4€', oeffnung:'Sommer', web:'erlangen.de', maps:'https://maps.google.com/?q=Bürgermeistersteg+Freibad+Erlangen' },
    { name:'Erlanger Stadtbad', addr:'Güterhallenstr. 4, 91052 Erlangen', city:'Erlangen', lat:49.5946, lng:11.0179, tags:['Hallenbad'], preis:'4.50€', oeffnung:'Ganzjährig', web:'erlangen.de', maps:'https://maps.google.com/?q=Stadtbad+Erlangen' },
    // Spaßbäder Region
    { name:'ALOHA Erlebnisbad Neumarkt', addr:'Badstr. 15, 92318 Neumarkt', city:'Neumarkt', lat:49.2781, lng:11.4612, tags:['Erlebnisbad','Rutsche','Sauna'], preis:'Erw. 12€, Kind 8€', oeffnung:'Mo-So 10-22 Uhr', web:'aloha-neumarkt.de', maps:'https://maps.google.com/?q=Aloha+Erlebnisbad+Neumarkt' },
    ...
    { name:'Atlantis Freizeitbad Gunzenhausen', addr:'Schlossstraße 15, 91710 Gunzenhausen', city:'Gunzenhausen', lat:49.1135, lng:10.7546, tags:['Erlebnisbad','Altmühlsee-Region'], preis:'Erw. 10€', oeffnung:'Di-So 10-20 Uhr', web:'', maps:'https://maps.google.com/?q=Atlantis+Freizeitbad+Gunzenhausen' },
    { name:'Aquamarin Weißenburg', addr:'Am Bahnhof 4, 91781 Weißenburg', city:'Weißenburg', lat:49.0350, lng:10.9719, tags:['Hallenbad'], preis:'4–6€', oeffnung:'Mo-Sa', web:'', maps:'https://maps.google.com/?q=Aquamarin+Weißenburg' },
    ...
    { name:'Aqualand Freizeitbad Forchheim', addr:'Seestr. 2, 91301 Forchheim', city:'Forchheim', lat:49.7155, lng:11.0654, tags:['Erlebnisbad','Freibad'], preis:'6–10€', oeffnung:'Ganzjährig', web:'', maps:'https://maps.google.com/?q=Aqualand+Forchheim' },
    ...
    { name:'Alpenbad Nesselwang', addr:'Osterbergstr. 1, 87484 Nesselwang', city:'Rammingen', lat:47.6241, lng:10.5027, tags:['Hallenbad','Alpenblick'], preis:'6–10€', oeffnung:'Mo-So', web:'', maps:'https://maps.google.com/?q=Alpenbad+Nesselwang' },
    ...
    { name:'Solbad Adelholzen', addr:'Bad-Adelholzen 1, 83313 Siegsdorf', city:'München', lat:47.8072, lng:12.6406, tags:['Therme','Sole','Wellness'], preis:'ab 16€', oeffnung:'tägl. 9-22 Uhr', web:'adelholzen.de', maps:'https://maps.google.com/?q=Solbad+Adelholzen' },
    { name:'Kristall Therme Mühldorf', addr:'Innstraße 42, 84453 Mühldorf', city:'München', lat:48.2451, lng:12.5239, tags:['Therme','Wellness'], preis:'ab 16€', oeffnung:'tägl.', web:'kristall-therme-muehldorf.de', maps:'https://maps.google.com/?q=Kristall+Therme+Mühldorf' },
    { name:'Bad Alexandersbad Fichtelgebirge', addr:'Alexanderstr. 1, 95680 Bad Alexandersbad', city:'Hof', lat:49.9958, lng:11.9849, tags:['Therme','Heilbad'], preis:'ab 12€', oeffnung:'tägl.', web:'', maps:'https://maps.google.com/?q=Bad+Alexandersbad' },
    { name:'Wogibad Weiden', addr:'Kreuzweg 1, 92637 Weiden', city:'Weiden', lat:49.6769, lng:12.1594, tags:['Hallenbad','Erlebnisbad'], preis:'5–9€', oeffnung:'Mo-So', web:'weiden.de', maps:'https://maps.google.com/?q=Wogibad+Weiden' },
  ],
  ...
  clubs: [
    // Nürnberg
    { name:'Hirsch Nürnberg', addr:'Vogelweiherstr. 66, 90441 Nürnberg', city:'Nürnberg', lat:49.4337, lng:11.0918, tags:['Konzerte','Club','Indie'], preis:'8-20€', oeffnung:'Events, siehe Website', web:'der-hirsch.de', maps:'https://maps.google.com/?q=Hirsch+Nürnberg', highlight:'Bekannteste Konzertlocation Nürnbergs' },
    ...
    { name:'Cult Club Nürnberg', addr:'Celtisplatz 13, 90403 Nürnberg', city:'Nürnberg', lat:49.4561, lng:11.0627, tags:['Mixed','Commercial','Club'], preis:'8-12€', oeffnung:'Fr/Sa ab 22 Uhr', web:'', maps:'https://maps.google.com/?q=Cult+Club+Nürnberg' },
    ...
    { name:'Kunstkulturquartier K4 Nürnberg', addr:'Königstr. 93, 90402 Nürnberg', city:'Nürnberg', lat:49.4490, lng:11.0831, tags:['Konzerte','Theater','Mix'], preis:'variabel', oeffnung:'Events', web:'kkquartier.de', maps:'https://maps.google.com/?q=K4+Nürnberg' },
    { name:'Club Stereo NBG (Tafelhalle)', addr:'Äußere Sulzbacher Str., 90491 Nürnberg', city:'Nürnberg', lat:49.4659, lng:11.1175, tags:['Techno','Underground'], preis:'10-20€', oeffnung:'WE', web:'', maps:'https://maps.google.com/?q=Stereo+Nürnberg' },
    // Fürth
    ...
    { name:'Kunstpalais Erlangen', addr:'Marktplatz 1, 91054 Erlangen', city:'Erlangen', lat:49.5953, lng:11.0027, tags:['Kunst','Events','Mix'], preis:'variabel', oeffnung:'Events', web:'', maps:'https://maps.google.com/?q=Kunstpalais+Erlangen' },
    // Überregional
    { name:'Berghain Berlin', addr:'Am Wriezener Bahnhof, 10243 Berlin', city:'Leipzig', lat:52.5102, lng:13.4440, tags:['Techno','Weltklasse','24h'], preis:'10-20€', oeffnung:'Fr ab 0 Uhr – So', web:'berghain.de', maps:'https://maps.google.com/?q=Berghain+Berlin', highlight:'Legendärster Club der Welt' },
  ],
