...
const CAT_COLORS = {festival:'#5b8ff9',volksfest:'#c8974e',afterwork:'#a78bfa',sonstige:'#34d399',family:'#34d399',russian:'#f472b6',strand:'#06b6d4',beachparty:'#fbbf24',messe:'#64748b',weinfest:'#a855f7',privat:'#c9a227',zoo:'#10b981',freizeit:'#f97316',kinder:'#ec4899',stadtfest:'#8b5cf6',sport:'#ef4444',badesee:'#0ea5e9'};
...
const familyEvents = [
  ...
  // ─── BADESEEN ─────────────────────────────────────────────────────────────────
  // Oberbayern
  {cat:'badesee', name:'Chiemsee', loc:'Prien / Chieming / Übersee – Chiemgau (ca. 110 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'79,9 km²', desc:'Das „Bayerische Meer" – mit 80 km² Bayerns größter See. Badestellen in Prien, Chieming, Übersee und auf den Inseln Herreninsel & Fraueninsel. Hervorragende Wasserqualität. Ausflugsboote zu den Inseln mit dem berühmten Schloss Herrenchiemsee.', genre:'Badesee / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Prien am Chiemsee, dann Schiff', parking:'Vorhanden an den Seezentren'},
  {cat:'badesee', name:'Starnberger See', loc:'Starnberg / Tutzing / Possenhofen (ca. 90 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'56,4 km²', desc:'Zweitgrößter Naturbadesee Bayerns mit kristallklarem Wasser und Blick auf die Alpen. Beliebte Badestellen in Seeshaupt, Ambach, Tutzing und am Strandbad Berg. Mit dem S-Bahn-Netz München gut erreichbar.', genre:'Badesee / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (kostenpfl. Strandbäder ab ca. 3 €)', oepnv:'S6 bis Starnberg oder Tutzing', parking:'Vorhanden an den Strandbädern'},
  {cat:'badesee', name:'Ammersee', loc:'Herrsching / Dießen / Stegen (ca. 80 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'46,6 km²', desc:'Drittgrößter Naturbadesee Bayerns im Fünfseenland. Exzellente Wasserqualität, viele kostenlose öffentliche Badestellen und romantische Uferpromenaden. Herrsching ist das beliebteste Ausflugsziel und per S-Bahn erreichbar.', genre:'Badesee / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Strandbäder ab ca. 3 €)', oepnv:'S8 bis Herrsching', parking:'Vorhanden, an Wochenenden früh kommen'},
  {cat:'badesee', name:'Tegernsee', loc:'Rottach-Egern / Bad Wiessee / Gmund (ca. 100 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'8,8 km²', desc:'Traumsee im bayerischen Voralpenland mit glasklarem, blaugrünem Wasser. Umrahmt von Bergen und mondänen Ortschaften. Badestellen in Gmund, Bad Wiessee und Rottach-Egern. Wassertemperaturen erreichen im Sommer bis 22 °C.', genre:'Badesee / Alpen / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Strandbäder ab ca. 4 €)', oepnv:'Bahn nach Tegernsee', parking:'Vorhanden, frühzeitig anreisen'},
  {cat:'badesee', name:'Walchensee', loc:'Walchensee – Oberbayern (ca. 130 km)', start:'2026-05-15', end:'2026-09-15', free:true, size:'16,4 km²', desc:'Einer der tiefsten und klarsten Bergseen Deutschlands (75 m tief, Sichttiefe bis 12 m). Smaragdgrünes Wasser, Bergpanorama und Wassersportparadies. Baden an der Nordseite bei Walchensee-Dorf. Wassertemperatur bleibt eher kühl (max. 18 °C).', genre:'Badesee / Bergsee / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Kochel am See, dann Bus 9608', parking:'Vorhanden am Westufer'},
  {cat:'badesee', name:'Kochelsee', loc:'Kochel am See (ca. 125 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'5,6 km²', desc:'Naturbelassener Voralpensee direkt bei Kochel am See. Idealer Abstecher zum Walchensee. Freibad Kochel am See mit Wasserrutsche. Ruhiger als der Tegernsee, mit schönem Blick auf die Voralpen.', genre:'Badesee / Voralpen / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 4 €', oepnv:'Bahn nach Kochel am See', parking:'Vorhanden am Freibad'},
  {cat:'badesee', name:'Waginger See', loc:'Waging am See – Chiemgau (ca. 165 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'5,7 km²', desc:'Der wärmste Badesee Oberbayerns – Wassertemperaturen bis 27 °C im Hochsommer! Flach und sandige Ufer, ideal für Familien. Hervorragende Wasserqualität. Wassersport-Paradies mit Surfschule, SUP und Segelboot-Verleih.', genre:'Badesee / Familienbadesee / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Strandbäder ab ca. 3 €)', oepnv:'Bahn nach Freilassing, dann Bus 161', parking:'Vorhanden am Westufer und Ostseite'},
  {cat:'badesee', name:'Tachinger See', loc:'Taching am See – Chiemgau (ca. 165 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,6 km²', desc:'Kleiner, idyllischer Schwester-See des Waginger Sees. Ähnlich warm und mit ruhigerer Atmosphäre. Flache Ufer, ideal für Kinder. Über einen Kanal mit dem Waginger See verbunden. Toller Campingplatz direkt am Seeufer.', genre:'Badesee / Familienbadesee', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Freilassing, dann Bus 161', parking:'Vorhanden'},
  {cat:'badesee', name:'Königssee', loc:'Schönau am Königssee – Berchtesgadener Land (ca. 180 km)', start:'2026-05-15', end:'2026-09-15', free:true, size:'5,2 km²', desc:'Einer der eindrucksvollsten Bergseen Deutschlands – eingebettet in senkrechte Felswände im Nationalpark Berchtesgaden. Baden ist an ausgewiesenen Stellen in Schönau erlaubt. Elektroboote zur Wallfahrtskirche St. Bartholomä. Sehr kaltes Wasser (max. 16 °C).', genre:'Badesee / Bergsee / Nationalpark', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Bootsfahrt: ab 12 €)', oepnv:'Bahn nach Berchtesgaden Hbf, dann Bus 841', parking:'Schönau am Königssee (kostenpflichtig)'},
  {cat:'badesee', name:'Wörthsee', loc:'Wörthsee – Fünfseenland (ca. 100 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'1,9 km²', desc:'Schöner Natursee im beliebten Fünfseenland, mit idyllischen Ufern und klarem Wasser. Öffentliche Badestellen am Nordwestufer. Etwas ruhiger als Ammersee und Starnberger See. Wenig Trubel.', genre:'Badesee / Fünfseenland', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'S8 bis Geltendorf, dann Bus', parking:'Begrenzt – frühzeitig anreisen'},
  {cat:'badesee', name:'Pilsensee', loc:'Seefeld-Hechendorf – Fünfseenland (ca. 95 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'2,3 km²', desc:'Ruhigerer Begleitsee des Ammersees im Fünfseenland. Weniger bekannt, daher oft ohne Gedränge. Natürliche Ufer, familienfreundlich und mit schönem Blick auf die Alpenkette.', genre:'Badesee / Fünfseenland', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'S8 bis Herrsching oder Geltendorf, dann Rad/Bus', parking:'Begrenzt'},
  {cat:'badesee', name:'Simssee', loc:'Bad Endorf – Chiemgau (ca. 105 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'5,0 km²', desc:'Geheimtipp im Chiemgau – die ruhigere Alternative zum Chiemsee. Naturbelassene Ufer, exzellente Wasserqualität und Seeblick auf die Chiemgauer Alpen. Strandbad und öffentliche Badestellen in Bad Endorf.', genre:'Badesee / Chiemgau / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Bad Endorf', parking:'Vorhanden'},
  {cat:'badesee', name:'Riegsee', loc:'Riegsee – Blaues Land bei Murnau (ca. 110 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'1,0 km²', desc:'Malerischer kleiner See im „Blauen Land" bei Murnau, der Region der Künstler (Kandinsky, Münter). Glasklares Wasser, Bergpanorama und völlig kostenloses Baden ohne Massentourismus. Direktes Zelten am Ufer möglich.', genre:'Badesee / Blaues Land / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Murnau, dann Bus oder Rad', parking:'Kleiner Parkplatz am See'},
  {cat:'badesee', name:'Staffelsee', loc:'Uffing am Staffelsee – Blaues Land bei Murnau (ca. 115 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'7,8 km²', desc:'Großer Natursee mit sieben Inseln im Blauen Land bei Murnau. Warmes, klares Wasser, idyllische Landschaft und Bergpanorama. Öffentliche Badestellen in Uffing und Seehausen. Beliebt bei Kitesurfern und Seglern.', genre:'Badesee / Blaues Land / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Murnau, dann Bus oder Rad', parking:'Vorhanden in Uffing'},
  {cat:'badesee', name:'Feringasee', loc:'Unterföhring bei München (ca. 165 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'14 ha', desc:'Kiesgrubensee direkt vor München mit sonnigen Liegewiesen, FKK-Bereich und hervorragender Wasserqualität. Einer der beliebtesten Naherholungsseen im Münchner Norden. Am Wochenende früh anreisen.', genre:'Badesee / Naherholung München', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'U4 bis Arabellapark, dann Bus 230', parking:'Begrenzt, kostenpflichtig'},
  {cat:'badesee', name:'Unterschleißheimer See', loc:'Unterschleißheim bei München (ca. 170 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'22 ha', desc:'Beliebter Badesee im Münchner Norden mit Freibad, Liegewiesen und Spiel-/Sportanlagen. Ideal für Familien mit Kindern als Tagesausflug vom Raum Nürnberg über die Autobahn.', genre:'Badesee / Naherholung München', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Freibadbereich: ca. 4 €)', oepnv:'S1 bis Unterschleißheim', parking:'Vorhanden am Freibad'},

  // Allgäu / Schwaben
  {cat:'badesee', name:'Forggensee', loc:'Füssen – Allgäu (ca. 160 km)', start:'2026-06-01', end:'2026-09-30', free:true, size:'15,7 km²', desc:'Größter Stausee Bayerns – im Sommer aufgestaut zum Freizeitparadies mit Sandstränden, Segeln, SUP und Windsurfen. Einmaliger Blick auf Schloss Neuschwanstein und Schloss Hohenschwangau. Badesaison ab Juni wenn der See voll aufgestaut ist.', genre:'Badesee / Stausee / Allgäu', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Füssen, dann Bus zum Seeufer', parking:'Vorhanden an den Strandbädern'},
  {cat:'badesee', name:'Großer Alpsee', loc:'Immenstadt im Allgäu (ca. 175 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'1,8 km²', desc:'Größter natürlicher See im Allgäu – klares Bergwasser und beeindruckendes Panorama auf die Allgäuer Alpen. Freibad und freie Badestellen. Beliebtes Ziel für Wassersport. Im Sommer oft starker Wind – ideal für Surfer und Segler.', genre:'Badesee / Allgäu / Bergpanorama', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 3 €, freie Stellen: kostenlos', oepnv:'Bahn nach Immenstadt im Allgäu', parking:'Vorhanden am Freibad und Westufer'},
  {cat:'badesee', name:'Kleiner Alpsee', loc:'Bühl am Alpsee bei Immenstadt (ca. 177 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,17 km²', desc:'Idyllisches kleines Schwesterchen des Großen Alpsees – ruhig, wenig Badegäste und herrlicher Bergblick. Natur pur, keine kommerzielle Infrastruktur. Beliebter Geheimtipp für ruhiges Naturerlebnis direkt neben dem Großen Alpsee.', genre:'Badesee / Allgäu / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Immenstadt, dann Rad', parking:'Begrenzt in Bühl'},
  {cat:'badesee', name:'Hopfensee', loc:'Hopfen am See bei Füssen – Allgäu (ca. 155 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'1,7 km²', desc:'Anerkanntes Heilklimatisches Kurgebiet mit moorhaltigen Sedimenten und heilendem Wasser. Traumhafter Blick auf die Zugspitze und die Allgäuer Alpen. Freibad und freie Badestellen. Warmes, klares Wasser im Sommer.', genre:'Badesee / Allgäu / Heilklimatisch', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos (Strandbad: ca. 4 €)', oepnv:'Bahn nach Füssen, dann Bus 73 nach Hopfen am See', parking:'Vorhanden am See'},
  {cat:'badesee', name:'Weißensee', loc:'Weißensee bei Füssen – Allgäu (ca. 155 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,7 km²', desc:'Kleiner, ruhiger Bergsee nahe Füssen mit kristallklarem Wasser und Alpenpanorama. Umgeben von Wald und Wiesen. Wenig erschlossen – echter Geheimtipp für Naturliebhaber. Nur wenige hundert Meter vom Hopfensee entfernt.', genre:'Badesee / Allgäu / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Füssen, dann Bus oder Rad', parking:'Begrenzt'},
  {cat:'badesee', name:'Rottachsee', loc:'Rettenberg – Oberallgäu (ca. 185 km)', start:'2026-05-15', end:'2026-09-15', free:true, size:'2,5 km²', desc:'Größter See im Oberallgäu – ruhige, naturnahe Stimmung mit Blick auf die Allgäuer Alpen und die Grünten-Bergkette. Naturstrand, Wasserwacht und Bootsverleih. Ideal kombinierbar mit einer Wanderung rund um den See.', genre:'Badesee / Oberallgäu / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Kempten, dann Bus nach Rettenberg', parking:'Vorhanden am Westufer'},
  {cat:'badesee', name:'Autobahnsee Augsburg', loc:'Augsburg-Leitershofen (ca. 100 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'38 ha', desc:'Bekannter Naherholungs-Badesee direkt an der A8 westlich von Augsburg. Großes Freibadgelände, Wasserrutsche, Beachvolleyball, FKK-Bereich. Sehr gut ausgestattet und im Sommer sehr gut besucht.', genre:'Badesee / Freizeitbad / Augsburg', ticket:'', outdoor:true, ageMin:0, price:'Eintritt: ca. 5 €', oepnv:'Bahn nach Augsburg Hbf, dann Bus 34', parking:'Vorhanden (kostenpflichtig)'},
  {cat:'badesee', name:'Kuhsee Augsburg', loc:'Augsburg-Haunstetten (ca. 100 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'11 ha', desc:'Naturnaher Badesee im Augsburger Süden – ruhiger und weniger kommerziell als der Autobahnsee. FKK-Bereich am Südende. Liegewiesen und kleine Imbissbuden. Beliebtes Ziel für Radler und Spaziergänger.', genre:'Badesee / Naherholung Augsburg', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Augsburg Hbf, dann Tram 3 bis Haunstetten', parking:'Vorhanden'},

  // Fränkisches Seenland
  {cat:'badesee', name:'Großer Brombachsee', loc:'Pleinfeld / Enderndorf – Fränkisches Seenland (ca. 45 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'9,1 km²', desc:'Das Herzstück des Fränkischen Seenlands – größter Stausee der Region mit langen Sandstränden, Segelhafen, SUP-Verleih und ausgezeichneter Wasserqualität. Seepark Ramsberg und Seezentren Langlau & Enderndorf. Blaue Flagge EU. Triathlon-Ziel.', genre:'Badesee / Fränkisches Seenland / Wassersport', ticket:'https://www.brombachsee.de', outdoor:true, ageMin:0, price:'Eintritt Seezentrum: ca. 5 €, freie Badestellen: kostenlos', oepnv:'S1 bis Pleinfeld, dann Bus oder Rad', parking:'Vorhanden an den Seezentren'},
  {cat:'badesee', name:'Kleiner Brombachsee', loc:'Ramsberg – Fränkisches Seenland (ca. 50 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,6 km²', desc:'Der kleine Bruder des Großen Brombachsees – ruhigere Atmosphäre, naturbelassene Ufer und Blick auf den Bismarckturm. Seepark Ramsberg mit Liegewiesen. Ideal für Familien mit Kindern, die wenig Trubel suchen.', genre:'Badesee / Fränkisches Seenland / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Georgensgmünd, dann Bus oder Rad', parking:'Vorhanden in Ramsberg'},
  {cat:'badesee', name:'Altmühlsee', loc:'Gunzenhausen – Fränkisches Seenland (ca. 50 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'5,5 km²', desc:'Zweitgrößter See des Fränkischen Seenlands mit langen Sandstränden, der bekannten Vogelinsel (über 100 Brutvogelarten) und breitem Wassersportangebot. Strandbar, Liegewiesen und Aussichtsturm. Blaue Flagge EU.', genre:'Badesee / Fränkisches Seenland / Vogelinsel', ticket:'', outdoor:true, ageMin:0, price:'Eintritt Strandbad: ca. 4 €', oepnv:'Bahn nach Gunzenhausen', parking:'Vorhanden am Strandbad'},
  {cat:'badesee', name:'Rothsee', loc:'Rohr in Mittelfranken – Fränkisches Seenland (ca. 40 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'3,1 km²', desc:'Beliebter Naherholungs- und Triathlonbadesee im Fränkischen Seenland nahe Nürnberg. Gut ausgestattetes Strandbad mit Wasserrutsche, Beachvolleyball und Liegewiesen. Startort des Rothsee-Triathlons. Exzellente Wasserqualität.', genre:'Badesee / Fränkisches Seenland / Sport', ticket:'', outdoor:true, ageMin:0, price:'Strandbad: ca. 4 €', oepnv:'S1 bis Georgensgmünd, dann Bus 617', parking:'Vorhanden am Strandbad'},
  {cat:'badesee', name:'Hahnenkammsee', loc:'Hahnenkamm – Fränkisches Seenland (ca. 60 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,6 km²', desc:'Der älteste und ruhigste See des Fränkischen Seenlands – bereits 1978 aufgestaut. Naturbelassene Ufer, wenig Betrieb und idyllische Landschaft. Ideal für Erholung ohne Menschenmassen. Naturbadestrand in Absberg.', genre:'Badesee / Fränkisches Seenland / Ruheoase', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Gunzenhausen, dann Bus', parking:'Kleiner Parkplatz in Absberg'},

  // Oberpfalz / Bayerischer Wald
  {cat:'badesee', name:'Steinberger See', loc:'Steinberg am See – Oberpfalz (ca. 75 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'2,8 km²', desc:'Größter See der Oberpfalz mit der weltberühmten Erlebnisholzkugel auf dem Wasser. Umgewidmeter Braunkohletagebausee mit breiten Sandstränden, Wasserski-Anlage, Windsurfen und SUP. Top-Wasserqualität, Blaue Flagge EU.', genre:'Badesee / Oberpfalz / Wassersport', ticket:'', outdoor:true, ageMin:0, price:'Strandbad: ca. 5 €', oepnv:'Bahn nach Schwandorf, dann Bus 6407', parking:'Vorhanden, im Sommer kostenpflichtig'},
  {cat:'badesee', name:'Murner See', loc:'Wackersdorf – Oberpfalz (ca. 75 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,5 km²', desc:'Direkt neben dem Steinberger See – ebenfalls umgewidmeter Braunkohletagebausee mit naturbelassenen Ufern. Badestrand und Naturschutzzone teilen sich das Ufer. Ruhigere Alternative zum Trubel am Steinberger See.', genre:'Badesee / Oberpfalz / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Schwandorf, dann Bus 6407', parking:'Vorhanden'},
  {cat:'badesee', name:'Guggenberger See', loc:'Neutraubling bei Regensburg (ca. 90 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,35 km²', desc:'Der „Guggi" – Hauptbadesee im Raum Regensburg. Gut ausgestattetes Freibad mit Wasserrutsche, FKK-Bereich und Liegewiesen. Warm und familienfreundlich. Kiesgruben-Ursprung garantiert gute Wasserqualität.', genre:'Badesee / Regensburg / Freizeitbad', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 4 €', oepnv:'Bahn nach Regensburg Hbf, dann Bus nach Neutraubling', parking:'Vorhanden am Freibad'},
  {cat:'badesee', name:'Sperlsee', loc:'Viechtach – Bayerischer Wald (ca. 135 km)', start:'2026-05-15', end:'2026-09-15', free:true, size:'0,4 km²', desc:'Idyllischer Natursee im Bayerischen Wald bei Viechtach. Liebevoll ausgebautes Freibad mit Steg, Liegewiesen und Campingmöglichkeit. Ruhige, naturbelassene Umgebung – ideal für Familien und Wanderer.', genre:'Badesee / Bayerischer Wald / Naturerlebnis', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 3 €', oepnv:'Bahn nach Viechtach', parking:'Vorhanden am Freibad'},
  {cat:'badesee', name:'Satzdorfer See', loc:'Regen – Bayerischer Wald (ca. 150 km)', start:'2026-05-15', end:'2026-09-15', free:true, size:'0,3 km²', desc:'Kleiner Natursee bei Regen im Bayerischen Wald – ruhige Idylle mit naturbelassenem Badestrand. Gute Wasserqualität, Liegewiesen und Waldspaziergang drum herum. Charmanter Geheimtipp für Naturliebhaber.', genre:'Badesee / Bayerischer Wald / Geheimtipp', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bahn nach Regen', parking:'Kleiner Parkplatz am See'},

  // Franken (abseits des Seenlands)
  {cat:'badesee', name:'Untreusee', loc:'Hof – Oberfranken (ca. 125 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'1,1 km²', desc:'Beliebtester Badesee Oberfrankens direkt bei Hof – mit Sandstrand, Freibad, FKK-Bereich und Minigolfanlage. Gut ausgebaut und familienfreundlich. Erreichbar zu Fuß oder mit dem Rad vom Hofer Bahnhof. Sauber und gepflegt.', genre:'Badesee / Oberfranken / Freizeitbad', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 4 €', oepnv:'Bahn nach Hof Hbf, dann Bus oder Rad (2 km)', parking:'Vorhanden am Strandbad'},
  {cat:'badesee', name:'Trebgaster Badesee', loc:'Trebgast – Landkreis Kulmbach (ca. 100 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'5 ha', desc:'Beliebter Naherholungssee im Landkreis Kulmbach mit gepflegtem Freibad, Liegewiesen und Spielbereich für Kinder. Hervorragende Wasserqualität, ruhige Lage. Idealer Sommertag-Ausflug für Familien aus dem Raum Kulmbach und Bayreuth.', genre:'Badesee / Oberfranken / Familienbadesee', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 3 €', oepnv:'Bahn nach Kulmbach, dann Bus nach Trebgast', parking:'Vorhanden am Freibad'},
  {cat:'badesee', name:'Baggersee Schweinfurt', loc:'Schweinfurt – Unterfranken (ca. 110 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'0,6 km²', desc:'Großes Freizeitzentrum an der Mainlände in Schweinfurt mit Badesee, Freibad, Beachvolleyball, Discgolf und Grillplätzen. FKK-Bereich vorhanden. Sehr gut ausgestattet und im Sommer geselliger Treffpunkt der Region.', genre:'Badesee / Unterfranken / Freizeitbad', ticket:'', outdoor:true, ageMin:0, price:'Freibad: ca. 4 €', oepnv:'Bahn nach Schweinfurt Hbf, dann Bus', parking:'Vorhanden am Freizeitzentrum'},
  {cat:'badesee', name:'Erlanger Dechsendorfer Weiher', loc:'Erlangen-Dechsendorf (ca. 20 km)', start:'2026-05-01', end:'2026-09-30', free:true, size:'15 ha', desc:'Klassischer Badeweiher Mittelfrankens – das nahe Erlanger Naherholungsgebiet mit Liegewiesen, Beachvolleyball, Wasserwacht und FKK-Bereich. Exzellente Wasserqualität, familienfreundlich und gut mit ÖPNV erreichbar. Beliebt bei Erlangern und Nürnbergern.', genre:'Badesee / Mittelfranken / Naherholung', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Bus 297 ab Erlangen Arcaden Richtung Dechsendorf', parking:'Vorhanden am Weiher'},
];
