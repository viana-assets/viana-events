const CAT_COLORS = {festival:'#5b8ff9',kaerwa:'#c8974e',bierfest:'#e8963a',afterwork:'#a78bfa',sonstige:'#34d399',family:'#34d399',russian:'#f472b6'};
const CAT_LABELS = {festival:'Festival',kaerwa:'Kärwa / Kirchweih',bierfest:'Bierfest',afterwork:'After Work / Club',sonstige:'Sonstiges',family:'Familie',russian:'🇷🇺 Russian Event'};
...
const events = [
  ...
  // ─── FESTIVALS ────────────────────────────────────────────────────────────
  {cat:'festival', name:'Nürnberg Punk Fest', loc:'Künstlerhaus Nürnberg', start:'2026-02-20', end:'2026-02-21', free:false, desc:'Wasted Open Air + KNRD Fest – 30 Bands auf 3 Bühnen. Bereits ausverkauft!', genre:'Punk/Hardcore', ticket:'', outdoor:false, ageMin:16, price:'Ausverkauft', oepnv:'U-Bahn bis Nürnberg Hauptbahnhof, 2 min Fußweg', parking:'Tiefgarage Bahnhof'},
  ...
  {cat:'festival', name:'Klassik Open Air', loc:'Luitpoldhain, Nürnberg', start:'2026-07-15', end:'2026-07-16', free:true, desc:'Europas größtes Klassik Open Air – ~160.000 Besucher. Staatsphilharmonie & Symphoniker. Mit Feuerwerk. EINTRITT FREI!', genre:'Klassik', ticket:'', outdoor:true, ageMin:0, price:'Kostenlos', oepnv:'Tram 9 oder Bus bis Luitpoldhain', parking:'Volksfestplatz (begrenzt) – ÖPNV empfohlen'},
  ...
  {cat:'afterwork', name:'Gate After Work (wöchentlich Do)', loc:'Gate Club, Airport Nürnberg', start:'2026-04-09', end:'2026-04-09', free:false, desc:'Jeden Donnerstag ab 19 Uhr: House & Mainstream. Im Sommer Rooftop-Events auf Dachterrasse mit Vorfeldblick.', genre:'House / Rooftop', ticket:'https://gate-nuernberg.de/', outdoor:false, ageMin:18, price:'Eintritt variiert', oepnv:'S-Bahn S2 bis Flughafen', parking:'Parkhaus Airport'},
  {cat:'afterwork', name:'PARKS After Work Party (2× mtl.)', loc:'PARKS, Berliner Platz 9', start:'2026-04-09', end:'2026-04-09', free:false, desc:'2× im Monat donnerstags ab 20 Uhr. DJ Werner & Friends – House.', genre:'House / Club', ticket:'https://www.parks-nuernberg.de/after-work-party/', outdoor:false, ageMin:18, price:'5 €', oepnv:'U-Bahn U2 bis Plärrer', parking:'Tiefgarage Plärrer'},
  ...
  {cat:'festival', name:'Ragnarök Festival', loc:'Lichtenfels', start:'2026-04-09', end:'2026-04-11', free:false, desc:'Renommiertes Pagan-, Folk- und Black-Metal-Festival seit 2004 in Lichtenfels. Ca. 4.000 Besucher, 30 Bands – u.a. Hypocrisy und Abbath.', genre:'Pagan / Folk / Black Metal', ticket:'https://www.ragnaroek-festival.de', outdoor:false, ageMin:18, price:'ab 55 €', oepnv:'Zug bis Lichtenfels', parking:'Vorhanden'},
  ...
  {cat:'festival', name:'Braincrusher In Hell – Jubilee', loc:'Hirschaid (bei Bamberg)', start:'2026-03-27', end:'2026-03-28', free:false, desc:'25-jähriges Jubiläum in der Jahnhalle Hirschaid. 16 Bands aus Doom, Death- und Black-Metal. Headliner: Grave (Schweden) und Samael (Schweiz).', genre:'Metal / Doom / Death Metal', ticket:'https://braincrusher.de', outdoor:false, ageMin:18, price:'ab 35 €', oepnv:'Zug bis Hirschaid', parking:'Vorhanden'},
  ...
  {cat:'russian', name:'White Rabbit – БОЛЬШАЯ ВЕЧЕРИНКА 90X 00X', loc:'Nürnberg – Club SOCIETY', start:'2026-04-10', end:'2026-04-10', free:false, desc:'Große Party mit 90er & 2000er Hits im Club SOCIETY Nürnberg. Veranstaltet von White Rabbit NBG (@white.rabbit.nbg). Russisch-internationale Party-Atmosphäre.', genre:'90er / 2000er / Party', ticket:'https://www.instagram.com/white.rabbit.nbg', outdoor:false, ageMin:18, price:'Infos via Instagram', oepnv:'U-Bahn nach Lorenzkirche oder Weißer Turm', parking:'Innenstadt Parkhäuser'},
  ...
  // ─── TRUSSMEE @ MAXIM FÜRTH (monatliche Events) ──────────────────────────
  {cat:'russian', name:'Trussmee Party', loc:'Fürth – Maxim Club', start:'2026-05-02', end:'2026-05-02', free:false, desc:'Monatliche Trussmee-Party im Maxim Fürth – Elektronische Musik, wechselnde DJs und Acts. Aktuelle Termine auf Instagram und Facebook: Maxim Fürth.', genre:'Electronic / House / Techno', ticket:'https://www.facebook.com/maximfuerth', outdoor:false, ageMin:18, price:'ca. 8–15 €', oepnv:'S-Bahn bis Fürth Hbf, dann Bus', parking:'Straße Fürth'},
  {cat:'russian', name:'Trussmee Party', loc:'Fürth – Maxim Club', start:'2026-06-06', end:'2026-06-06', free:false, desc:'Monatliche Trussmee-Party im Maxim Fürth. Aktuelle Termine auf Instagram und Facebook: Maxim Fürth.', genre:'Electronic / House / Techno', ticket:'https://www.facebook.com/maximfuerth', outdoor:false, ageMin:18, price:'ca. 8–15 €', oepnv:'S-Bahn bis Fürth Hbf, dann Bus', parking:'Straße Fürth'},
  {cat:'russian', name:'Trussmee Party', loc:'Fürth – Maxim Club', start:'2026-07-04', end:'2026-07-04', free:false, desc:'Monatliche Trussmee-Party im Maxim Fürth. Aktuelle Termine auf Instagram und Facebook: Maxim Fürth.', genre:'Electronic / House / Techno', ticket:'https://www.facebook.com/maximfuerth', outdoor:false, ageMin:18, price:'ca. 8–15 €', oepnv:'S-Bahn bis Fürth Hbf, dann Bus', parking:'Straße Fürth'},
  {cat:'russian', name:'Trussmee Party', loc:'Fürth – Maxim Club', start:'2026-08-01', end:'2026-08-01', free:false, desc:'Monatliche Trussmee-Party im Maxim Fürth. Aktuelle Termine auf Instagram und Facebook: Maxim Fürth.', genre:'Electronic / House / Techno', ticket:'https://www.facebook.com/maximfuerth', outdoor:false, ageMin:18, price:'ca. 8–15 €', oepnv:'S-Bahn bis Fürth Hbf, dann Bus', parking:'Straße Fürth'},
  {cat:'russian', name:'Trussmee Party', loc:'Fürth – Maxim Club', start:'2026-09-05', end:'2026-09-05', free:false, desc:'Monatliche Trussmee-Party im Maxim Fürth. Aktuelle Termine auf Instagram und Facebook: Maxim Fürth.', genre:'Electronic / House / Techno', ticket:'https://www.facebook.com/maximfuerth', outdoor:false, ageMin:18, price:'ca. 8–15 €', oepnv:'S-Bahn bis Fürth Hbf, dann Bus', parking:'Straße Fürth'},
...
// ─── RUSSIAN SENSATION FESTIVAL ──────────────────────────────────────────
  {cat:'russian', name:'Russian Sensation Festival', loc:'Straubing', start:'2026-04-11', end:'2026-04-11', free:false, desc:'Europas groesstes Russian Event! Russian Sensation Festival in Straubing. DJs, Live Acts, russische Partyatmosphaere. Weitere Termine auf russiansensationfestival.de', genre:'Russian Party / Festival', ticket:'https://www.eventbrite.de/o/russian-sensation-festival-104078548441', outdoor:false, ageMin:18, price:'Infos via Eventbrite', oepnv:'Bahn nach Straubing Hbf', parking:'Vorhanden'},

  // ─── SOYUZ EVENTS ─────────────────────────────────────────────────────────
  {cat:'russian', name:'SOYUZ Events – Russian Night', loc:'Regensburg – Lou Bar', start:'2026-04-11', end:'2026-04-11', free:false, desc:'SOYUZ Events präsentiert eine russische Partynacht im Lou Bar Regensburg. Musik, Vibes und russische Community-Atmosphäre. Infos auf @soyuz_events (Instagram).', genre:'Russian Party / Club', ticket:'https://www.instagram.com/soyuz_events', outdoor:false, ageMin:18, price:'Infos via Instagram', oepnv:'Bahn nach Regensburg Hbf', parking:'Innenstadt Parkhäuser'},
...
function openModal(idx) {
  ...
  const gmapsUrl=`https://www.google.com/maps/search/?api=1&query=${locEncoded}`;
  const appleMapsUrl=`https://maps.apple.com/?q=${locEncoded}`;
  ...
  document.getElementById('m-actions').innerHTML = `
    ...
    <div class="modal-action-section">
      ...
      <div class="mas-row mas-row-wrap">
        ...
        ${e.ticket?`<a class="mas-btn mas-ticket" href="${e.ticket}" target="_blank">🎟 Tickets</a>`:''}
      </div>
    </div>
    <div class="modal-action-section">
